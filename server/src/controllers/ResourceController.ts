...
class ResourceController {
   ...
   */
	public initializeRoutes(): void {
		this.router.route(this.path).get(this.getAllResources).post(this.createResource);
		this.router
			.route(this.path + '/:id')
   ...
   */
	getAllResources = async (request: Request, response: Response): Promise<void> => {
		try {
   ...
   * @param response HTTP browser response
   */
	downloadResource = async (request: Request, response: Response): Promise<void> => {
		try {
   ...
   * @param response HTTP browser response
   */
	updateResource = async (request: Request, response: Response): Promise<void> => {
		try {
   ...
   */
	...
	getallThreads = async (request: Request, response: Response): Promise<void> => {
		try {
