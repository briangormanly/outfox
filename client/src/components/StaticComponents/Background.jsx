        ...
        <Fragment>
            <h2 id = "background" className = "sub_header">Background</h2>
                <p> This is our capping project, Outfox. The idea for the project came from the desire to have an open source learning platform. 
                    ...
                    customizing them with their own resources that everyone can interact with. One of the most important aspects of Outfox is that
                    it offers users the ability to individually tailor their experience based on how they want it. <br /><br />
