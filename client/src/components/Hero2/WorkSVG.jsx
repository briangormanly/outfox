...
import { SVG } from './Hero2.elements';
...
const WorkSVG = () => {
	return (
		...
		>
			...
			/>
			<g opacity="0.5">
				<rect x="185.59736" y="510.28636" width="3" height="17" fill="#47e6b1" />
				<rect
					x="337.79868"
					y="640.37417"
					width="3"
			...
			<path
				...
				opacity="0.5"
			/>
			<circle cx="107.59736" cy="455.28636" r="6" fill="#f55f44" opacity="0.5" />
			<circle cx="321.59736" cy="6" r="6" fill="#8B0101" opacity="0.5" />
			<circle cx="463.79555" cy="457.93723" r="6" fill="#47e6b1" opacity="0.5" />
			<circle cx="809.79555" cy="607.93723" r="6" fill="#f55f44" opacity="0.5" />
			<rect
				x="688.162"
				y="277.83166"
				width="207.97236"
